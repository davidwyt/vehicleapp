...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_TABLE_INVITATIONVERDICT = "CREATE TABLE IF NOT EXISTS `INVITATIONVERDICT` (`INVITATIONID` CHAR(40) PRIMARY KEY NOT NULL, `SOURCE` VARCHAR(255) NOT NULL, `TARGET` VARCHAR(255) NOT NULL, `VERDICT` CHAR(250) NOT NULL, `FLAG` CHAR(250));";
	...
	private static final String DATABASE_TABLE_FOLLOWSHIPINVITATION = "CREATE TABLE IF NOT EXISTS `FOLLOWSHIPINVITATION` (`ID` CHAR(40) PRIMARY KEY NOT NULL, `SOURCE` VARCHAR(255) NOT NULL, `TARGET` VARCHAR(255) NOT NULL, `SENTTIME` INTEGER, `FLAG` CHAR(250));";
