...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_TABLE_FILEMESSAGE = "CREATE TABLE IF NOT EXISTS `FILEMESSAGE` (`TOKEN` CHAR(40) NOT NULL, `SOURCE` VARCHAR(255) NOT NULL, `TARGET` VARCHAR(255) NOT NULL, `CONTENT` BLOB NOT NULL, `SENTTIME` INTEGER, `FLAG` CHAR(250));";
