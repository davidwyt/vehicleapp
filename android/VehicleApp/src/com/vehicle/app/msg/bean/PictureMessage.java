...
public class PictureMessage implements IMessageItem, Parcelable {
	...
	public static final Parcelable.Creator<PictureMessage> CREATOR = new Parcelable.Creator<PictureMessage>() {

		@Override
		public PictureMessage createFromParcel(Parcel parcel) {
			// TODO Auto-generated method stub
			PictureMessage item = new PictureMessage();
		...
		@Override
		public PictureMessage[] newArray(int size) {
			// TODO Auto-generated method stub
			return new PictureMessage[size];
		}
