...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_TABLE_MESSAGE = "CREATE TABLE IF NOT EXIST `MESSAGE` (`ID` CHAR(40) PRIMARY KEY NOT NULL, `SOURCE` VARCHAR(255) NOT NULL, `TARGET` VARCHAR(255) NOT NULL, `CONTENT` TEXT NOT NULL, `SENTTIME` INTEGER, `STATUS` CHAR(40));";
